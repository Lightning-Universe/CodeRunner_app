...
class PythonTracer(TracerPythonScript):
    def __init__(self, script_path: str, script_args: Optional[Union[list, str]] = None, expected_symbol: str = None, **kwargs):
    ...
    def _modify_script(self, img_path):
        content = ASTChecker.read_file(self.script_path)
        append_sys = [
            # "import sys\n",
